...
/*
  Controlador para ver listado de ciudades incluyendo una barra de paginación con botones para editar y borrar ciudades.
*/
...
// ************* Inicio de la página
htmlStart('Listado paginado (con botones)','Listado Paginado (botones)');
